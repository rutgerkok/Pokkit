...
public abstract class PokkitAbstractInventory implements Inventory {
     ...
     *
     * <p>
     * Existing stacks will be filled up to {@link Math#min(int, int)
     * Math.min}({@link Material#getMaxStackSize()},
     * {@link Inventory#getMaxStackSize()}), while empty slots will be filled up
     * to {@link Inventory#getMaxStackSize()}.
     *
     * @param item
     *            The item.
